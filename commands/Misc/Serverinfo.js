...
module.exports = {
  name: "serverinfo",
  description: "Hiện thông tin Server",
  category: "misc",
  usage: "serverinfo",
  ...
  run: async (client, message, args) => {
    ...
    let guildFeatures = message.guild.features.join(`\n${await client.emoji("DGH_success")}: `)
            .replace(/animated_icon/ig, `Emoji Động`)
    ...
    let guildOwner = message.guild.ownerID; // await message.guild.members.fetch(message.guild.ownerID)
